...
export const Profile = () => {
    ...
    //De nuevo para refrescar la pagina y que se actualize TODO ver otra manera
    useEffect(() => {
        getDataUser()
        getCounters()
        setMore(true)
                ...
                <div className="profile-info__general-info">
                    ...
                    <div className="general-info__container-names">
                        <div className="container-names__name">
                            ...
                            {user._id != auth._id &&
                                (iFollow ?
                                    <button onClick={() => unfollow(user._id)} className="content__button content__button--right post__button">Dejar Seguir</button>
                                    :
